...
class ConfigurationActionTest {
    @Test
    fun parseJson() {
        val message = """{"elevation": {"terrain": [{"origin": {"theta": 0.0, "phi": 1.0}, "type": "hills"}, {"origin": {"theta": 2.0, "phi": 3.0}, "type": "ranges"}, {"origin": {"theta": 4.0, "phi": 5.0}, "type": "continents"}], "radius": 100.0}, "hero_actor_id": 5146106004195521549, "type": "configuration"}"""
